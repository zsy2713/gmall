...
import com.demo.gmall.manage.mapper.PmsBaseCatalog1Mapper;
import com.demo.gmall.manage.mapper.PmsBaseCatalog2Mapper;
import com.demo.gmall.manage.mapper.PmsBaseCatalog3Mapper;
...
public class CatalogServiceImpl implements CatalogService {
    ...
    public List<PmsBaseCatalog1> getCatalog1() {
        List<PmsBaseCatalog1> pmsBaseCatalog1s
    ...
    public List<PmsBaseCatalog2> getCatalog2(String catalog1Id) {
        ...
        List<PmsBaseCatalog2> pmsBaseCatalog2s
                = pmsBaseCatalog2Mapper.select(pmsBaseCatalog2);
    ...
    public List<PmsBaseCatalog3> getCatalog3(String catalog2Id) {
        ...
        List<PmsBaseCatalog3> pmsBaseCatalog3s
                = pmsBaseCatalog3Mapper.select(pmsBaseCatalog3);
